...
stack exec -- haddock --html  $hlib/WaiConstant.hs $hlib/GenePDFHtmlLib.hs  $hlib/AronHtml.hs $hlib/AronModule.hs $hlib/WaiLib.hs $hlib/AronGraphic.hs src/Main.hs --hyperlinked-source --odir=/tmp/doc  
