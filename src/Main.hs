...
{-|
    ...
    NOTE: NOT BEEN USED. parse the TAGS file
 -}
captureCppFun::[String] -> [(String, String)]
...
main = do 
       ...
       -- NOTE: TAGS file can be genrate by cpp_etags_emacs.sh
       cpptag <- getEnv "b" >>= \p -> return $ p </> "cpplib" </> "TAGS"
       ...
       printBox 2 ["Cpp functions are from TAGS file =>" ++ cpptag ++ "  => Generated by cpp_ctags_emacs.sh"]
